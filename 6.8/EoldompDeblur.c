		...
		for(z = 1; z < zMax - 1; z++)
		{
			for(y = 1; y < yMax - 1; y++)
			{
				for(x = 1; x < xMax - 1; x++)
				{
					...
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 1]) + 
						SQR(uInd - u[xyz_xmin + 1]) + 
						SQR(uInd - u[xyz_yplu + 1]) + 
						SQR(uInd - u[xyz_ymin + 1]) + 
						SQR(uInd - u[xyz_zplu + 1]) + 
						SQR(uInd - u[xyz_zmin + 1]));

					double uInd2 = u[xyzInd + 2];
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 2]) + 
						SQR(uInd - u[xyz_xmin + 2]) + 
						SQR(uInd - u[xyz_yplu + 2]) + 
						SQR(uInd - u[xyz_ymin + 2]) + 
						SQR(uInd - u[xyz_zplu + 2]) + 
						SQR(uInd - u[xyz_zmin + 2]));

					double uInd3 = u[xyzInd + 3];
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 3]) + 
						SQR(uInd - u[xyz_xmin + 3]) + 
						SQR(uInd - u[xyz_yplu + 3]) + 
						SQR(uInd - u[xyz_ymin + 3]) + 
						SQR(uInd - u[xyz_zplu + 3]) + 
						SQR(uInd - u[xyz_zmin + 3]));

					double uInd4 = u[xyzInd + 4];
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 4]) + 
						SQR(uInd - u[xyz_xmin + 4]) + 
						SQR(uInd - u[xyz_yplu + 4]) + 
						SQR(uInd - u[xyz_ymin + 4]) + 
						SQR(uInd - u[xyz_zplu + 4]) + 
						SQR(uInd - u[xyz_zmin + 4]));

					double uInd5 = u[xyzInd + 5];
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 5]) + 
						SQR(uInd - u[xyz_xmin + 5]) + 
						SQR(uInd - u[xyz_yplu + 5]) + 
						SQR(uInd - u[xyz_ymin + 5]) + 
						SQR(uInd - u[xyz_zplu + 5]) + 
						SQR(uInd - u[xyz_zmin + 5]));

					double uInd6 = u[xyzInd + 6];
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 6]) + 
						SQR(uInd - u[xyz_xmin + 6]) + 
						SQR(uInd - u[xyz_yplu + 6]) + 
						SQR(uInd - u[xyz_ymin + 6]) + 
						SQR(uInd - u[xyz_zplu + 6]) + 
						SQR(uInd - u[xyz_zmin + 6]));

					double uInd7 = u[xyzInd + 7];
					g[xyzInd] = 1.0 / sqrt(epsilon + 
						SQR(uInd - u[xyz_xplu + 7]) + 
						SQR(uInd - u[xyz_xmin + 7]) + 
						SQR(uInd - u[xyz_yplu + 7]) + 
						SQR(uInd - u[xyz_ymin + 7]) + 
						SQR(uInd - u[xyz_zplu + 7]) + 
						SQR(uInd - u[xyz_zmin + 7]));
						*/
				}
			}
		}
